...
// 用于封装压缩进度和最终结果的结构体
public struct XYZCompressionProgress {
   public let progress: CGFloat // 压缩进度百分比
   public let compressedData: Data? // 最终压缩的图片数据
}

public class XYZImageCompressor {
   ...
   public func compressImageWithProgress(image: UIImage?, targetSizeInKB: Int) -> Observable<XYZCompressionProgress> {
