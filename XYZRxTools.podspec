#
#  Be sure to run `pod spec lint XYZRxTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "14.0"
  s.source       = { :git => "https://github.com/brandy2015/XYZRxTools.git", :tag => "1.0.7"}
...
#s.source_files  = "XYZRxTools"#, "XYZRxTools/**/*.{h,m}"
